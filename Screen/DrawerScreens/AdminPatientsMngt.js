...
const AdminPatientScreen = () => {
  ...
  const fetchData = () => {
    ...
    const renderItem = ({ item }) => (
        <ResidentCell id={item.id} userid={item.user_id} completename={item.completename} sin={item.sin} address={item.address} city={item.city}
        ...
        <View>
          <View
              ...
              <TextInput
                ...
                placeholder='Search by name / sin'
                value={query}
